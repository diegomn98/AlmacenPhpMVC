...
<html>
    ...
    <body style="background-attachment:fixed;background-position:fixed;background-size:100% 100%;background-repeat:no-repeat;background-image:url(&quot;assets/img/warehouse.jpg&quot;);">
        ...
        <div style="opacity:0.9;margin:9%;width:80%;">
            ...
            <form action="Controladores/controladorDatosVenta.php">
                <table border="2px" style="background-color:rgb(226,230,46);" align="center" width="500px">
                    <tr align="center">
                        <th colspan="2">Venta de Caja</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            &nbsp;<input type="text" id="codigoCajaVenta" name="codigoCajaVenta" maxlength="12" required />&nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center"><button id="seleccionarVenta" name="seleccionarVenta">Seleccionar</button></td>
                    </tr>
                </table>
            </form>
